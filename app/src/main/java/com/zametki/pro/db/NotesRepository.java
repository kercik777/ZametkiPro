    ...
    public DashboardCounts getDashboardCounts() {
        ...
        try {
            String sql = "SELECT " +
                    ...
                    "SUM(CASE WHEN (" + DbHelper.C_ATTACHMENTS + " IS NOT NULL AND " + DbHelper.C_ATTACHMENTS + " != '[]' AND " + DbHelper.C_ATTACHMENTS + " != '') AND " + DbHelper.C_STATUS + "=" + DbHelper.STATUS_ACTIVE + " THEN 1 ELSE 0 END) " +
