...
public class MainActivity extends AppCompatActivity {
    ...
    private void selectFilter(long catId, int filter) {
        ...
        applyFilterUiRules();
        loadNotes();
        fab.setVisibility((filter == 4 || filter == 5) ? View.GONE : View.VISIBLE);
    }
    ...
    private void setupSelectionBar() {
        ...
        findViewById(R.id.sel_select_all).setOnClickListener(v -> {
            HapticUtils.light(v); adapter.selectAll();
        });
            ...
            if (currentFilter == 5) {
                ConfirmSheet.show(this, getString(R.string.main_delete_notes_forever, n),
                        ...
                        getString(R.string.delete), true, () -> {
                            ...
                            adapter.clearSelection();
                            loadNotes();
                            Snackbar.make(recycler, getString(R.string.main_selection_deleted, n), Snackbar.LENGTH_SHORT);
                        });
