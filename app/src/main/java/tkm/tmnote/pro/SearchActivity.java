...
public class SearchActivity extends AppCompatActivity {
    ...
    private long searchCategoryId = -1;
    ...
    protected void onCreate(Bundle b) {
        ...
        searchCategoryId = getIntent().getLongExtra("search_category_id", -1L);
        searchFilter = getIntent().getIntExtra("search_filter", 0);
    ...
    private void doSearch(String q) {
        ...
        AppExecutors.getInstance().diskIO().execute(() -> {
            final List<Note> result = repo.searchNotesContextual(query, searchCategoryId, searchFilter);
