...
public class Attachment implements Parcelable {
    ...
    public static List<Attachment> fromJson(String json) {
        ...
        for (String line : lines) {
            ...
            try {
                ...
                if (a.fileName.isEmpty()) a.fileName = null;
                a.displayName = unescape(parts[2]);
                if (a.displayName.isEmpty()) a.displayName = null;
    ...
    public static final Creator<Attachment> CREATOR = new Creator<Attachment>() {
        @Override public Attachment createFromParcel(Parcel in) { return new Attachment(in); }
        @Override public Attachment[] newArray(int size) { return new Attachment[size]; }
    };
}
